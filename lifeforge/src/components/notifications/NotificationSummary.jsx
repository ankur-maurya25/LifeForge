  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
      {cards.map((c) => (
        <div
          key={c.label}
          className={`p-4 sm:p-5 rounded-2xl border transition-all duration-300 shadow-xl ${c.color} flex flex-col justify-between`}
        >
